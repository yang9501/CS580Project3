        ...
        for feature_index in range(num_features):
            ...
            for threshold in possible_thresholds:
                ...
                if len(dataset_left)>0 and len(dataset_right)>0:
                    ...
                    curr_info_gain = self.information_gain(y, left_y, right_y, "entropy")                 #######MODIFY THIS TO FIND BEST WAY OF DETERMINING ATTRIBUTE
...
#print(data)
data.info()
X = data.iloc[:, -13:-1].values  #Get every column EXCEPT 'Type'
Y = data.iloc[:, 0].values.reshape(-1,1)    #Get 'Type' column
